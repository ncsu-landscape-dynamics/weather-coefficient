...
invisible(utils::memory.limit(264000))
...
output_directory <- "H:/My Drive/PoPS and Tangible Landscape/DaymetUS/Oregon"
study_area = "states"
states_of_interest <- c('Oregon')
lethal_temperature <- 'NO' # YES or NO
lethal_month ="01" # set to between "01" and "12"
lethal_min = 'NO' # YES or NO
